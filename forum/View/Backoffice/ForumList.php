        ...
        <?php foreach($list as $post) { ?>
            <div class="card">
                <div class="body">
                    ...
                    <span class="username">from: <?php echo $post['author']; ?></span>
                    <span class="created_at">Created at: <?php echo $post['created_at']; ?></span>
                    <div class="footer">
                        <div>
